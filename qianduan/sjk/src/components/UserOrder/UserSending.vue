    ...
    <div>
        ...
        <div class="body">
            <el-table :data="tableData" style="width: 100%" class="table" border>
                ...
                <el-table-column prop="cons_addre" label="取餐地址" min-width="30%" align="center">
                </el-table-column>
                <el-table-column prop="disp_id" label="送餐员编号" min-width="20%" align="center">
                </el-table-column>
                <el-table-column prop="disp_phone" label="送餐员电话" min-width="20%" align="center">
                </el-table-column>
                <el-table-column prop="deliver_time" label="预计送餐时间" min-width="20%" align="center">
                </el-table-column>
            </el-table>
        </div>
    </div>
